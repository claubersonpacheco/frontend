  ...
  <section class="space-y-6">
    ...
    <form class="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]" @submit.prevent="handleSubmit">
      <article class="rounded-[2rem] border border-white/70 bg-white/90 p-6 shadow-lg shadow-slate-900/5 backdrop-blur">
        ...
        <p v-if="successMessage" class="mt-5 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700">
          {{ successMessage }}
        </p>
      ...
      <aside class="rounded-[2rem] border border-ink-900/10 bg-[linear-gradient(180deg,_rgba(16,36,24,0.98),_rgba(22,57,38,0.96))] p-6 text-white shadow-xl shadow-ink-900/15">
        ...
        <div class="mt-8 space-y-3">
          ...
          <button
            type="button"
            class="inline-flex w-full items-center justify-center rounded-2xl border border-white/10 px-4 py-3 text-sm font-semibold text-white/85 transition hover:bg-white/8"
