...
<template>
  <main class="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-6xl space-y-6">
      <header
        class="relative z-20 rounded-md border border-white/70 bg-white/85 p-5 shadow-xl shadow-slate-900/5 backdrop-blur sm:p-6"
      >
      ...
      <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <article
          v-for="card in cards"
          :key="card.label"
          class="rounded-md border border-white/70 bg-white/85 p-5 shadow-lg shadow-slate-900/5 backdrop-blur"
        >
          ...
          <div class="mt-4 flex items-end justify-between">
            ...
            <span class="rounded-md bg-brand-50 px-3 py-1 text-xs font-semibold text-brand-700">
              {{ card.trend }}
            </span>
          </div>
        </article>
      ...
      <section class="grid gap-6 xl:grid-cols-[1.5fr_0.9fr]">
        <article
          class="rounded-md border border-white/70 bg-white/85 p-6 shadow-lg shadow-slate-900/5 backdrop-blur"
        >
          ...
          <div class="mt-6 space-y-4">
            <div class="flex items-start gap-4 rounded-md border border-slate-100 p-4">
              <div class="mt-1 size-3 rounded-md bg-brand-500"></div>
              <div>
            ...
            <div class="flex items-start gap-4 rounded-md border border-slate-100 p-4">
              <div class="mt-1 size-3 rounded-md bg-amber-400"></div>
              <div>
            ...
            <div class="flex items-start gap-4 rounded-md border border-slate-100 p-4">
              <div class="mt-1 size-3 rounded-md bg-sky-500"></div>
              <div>
        ...
        <aside
          class="rounded-md border border-ink-900/10 bg-[linear-gradient(180deg,_rgba(16,36,24,0.98),_rgba(22,57,38,0.96))] p-6 text-white shadow-xl shadow-ink-900/15"
        >
          ...
          <div class="mt-8 space-y-3">
            <RouterLink
              :to="{ name: 'profile' }"
              class="block rounded-md border border-white/10 bg-white/5 p-4 transition hover:bg-white/10"
            >
