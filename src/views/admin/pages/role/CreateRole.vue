  ...
  <section class="space-y-6">
    ...
    <article class="rounded-[2rem] border border-white/70 bg-white/90 p-6 shadow-lg shadow-slate-900/5 backdrop-blur">
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        <input v-model="form.moodleRoleId" placeholder="Moodle role ID" class="rounded-xl border-slate-200 px-4 py-3 text-sm" />
        <textarea v-model="form.description" placeholder="Descricao" class="rounded-xl border-slate-200 px-4 py-3 text-sm sm:col-span-2" />
