    ...
    <div class="px-4 py-4 sm:px-6 lg:px-8">
      <div class="mx-auto flex max-w-7xl items-center justify-between gap-4">
        <div class="flex items-center gap-3">
          <button
            type="button"
            class="inline-flex size-11 items-center justify-center rounded-md border border-slate-200 bg-white text-slate-700 shadow-sm transition hover:border-brand-200 hover:text-brand-700 lg:hidden"
        ...
        <div class="hs-dropdown relative inline-flex">
          <button
            ...
            type="button"
            class="hs-dropdown-toggle inline-flex items-center gap-x-3 rounded-md border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm transition hover:border-brand-200 hover:text-brand-700"
            aria-haspopup="menu"
            aria-expanded="false"
            aria-label="Menu do usuario"
          >
            <span class="flex size-10 items-center justify-center overflow-hidden rounded-full bg-brand-100 font-semibold text-brand-700">
              <img
          ...
          <div
            class="hs-dropdown-menu duration z-50 mt-2 hidden min-w-60 rounded-md border border-slate-200 bg-white p-2 opacity-0 shadow-xl transition-[opacity,margin] hs-dropdown-open:opacity-100"
            role="menu"
          ...
          >
            <div class="rounded-md bg-slate-50 px-3 py-3">
              ...
              <div class="mt-3 space-y-1">
                <RouterLink
                  :to="{ name: 'profile' }"
                  class="inline-flex w-full items-center gap-x-3 rounded-md px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-white hover:text-brand-700"
                >
                  <svg class="size-4 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                ...
                <button
                  type="button"
                  class="inline-flex w-full items-center gap-x-3 rounded-md px-3 py-2 text-sm font-medium text-red-600 transition hover:bg-white"
                  @click="handleLogout"
                >
