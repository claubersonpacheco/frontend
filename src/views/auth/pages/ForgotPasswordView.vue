      ...
      <div class="hidden bg-[linear-gradient(160deg,_#143b27,_#1f9d55_62%,_#b9efcb)] p-10 text-white xl:flex xl:flex-col xl:justify-between">
        ...
        <div class="space-y-4 rounded-[1.5rem] border border-white/10 bg-white/7 p-6">
          ...
          <div class="grid gap-3 text-sm text-white/80">
            <div class="rounded-xl border border-white/10 bg-white/5 px-4 py-3">Confira seu e-mail cadastrado</div>
            <div class="rounded-xl border border-white/10 bg-white/5 px-4 py-3">Abra o link de recuperacao</div>
            <div class="rounded-xl border border-white/10 bg-white/5 px-4 py-3">Crie uma nova senha segura</div>
          </div>
        </div>
      </div>
